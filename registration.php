        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">RESTAURANTE EL VIAJERO</small></h1>
                </div>
                ...
                <div class="col-xs-12 col-sm-6">
                   <br><br>
                    <div id="container-form">
                       <p style="color:#fff;" class="text-center lead">LLENAR TODOS LOS DATOS PARA REGISTRARSE</p>
                       <br><br>
