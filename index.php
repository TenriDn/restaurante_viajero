...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">RESTAURANTE EL VIAJERO</span> <small style="color: #fff;">UMG</small></h1>
      <p>
          Bienvenido a nuestra tienda en linea, puedes encontrar variedad de platillos.... en nuestro restaurante
      </p>
    </div>
